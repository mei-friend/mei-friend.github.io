...
For encoding projects with project-specific automation needs, mei-friend can be set up to use custom GitHub Actions workflows on your MEI files — see [Automation with GitHub Actions]({{ site.baseurl }}/docs/advanced/automation/) to learn how.
